...
parser.add_argument('-data',
                    help='path to dataset', default=r'D:\Project\Pot\efficientNet\dataset\dataset_V3')
...
def main():
    ...
    args.data = r'E:\all_flow\data\dataset_Data'
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    #     param_group['momentum'] = 0.001

    optimizer = torch.optim.AdamW(model.parameters(), lr=1e-3, weight_decay=1e-4)
    #换sgd 或者adamw weight_decay 5e-4; image_size=224
    ...
    train_dataset = datasets.ImageFolder(
        traindir,
        transforms.Compose([
            transforms.RandomResizedCrop(image_size, scale=(0.5,1.0), ratio=(0.75,1.33333), antialias=True),
    ...
    early_stopper = EarlyStopper(patience=45, min_delta=0.005)
    use_cos = False
