...
class VideoPotDetector:
    ...
    def classify_region(self, region_image):
        ...
        try:
            # 预处理图像
            input_tensor = self.preprocess_image(region_image)
...
def main():
    ...
    efficientnet_model_path = r"E:\all_flow\efficientnet_b0_best_gsy.pth"  # 替换为您的EfficientNet模型路径
    # address = [r"F:\all_flow\源哥\SpillOver_20250928_155913_ori.avi",r"F:\all_flow\源哥\SpillOver_20250928_160121_ori.avi",r"F:\all_flow\源哥\SpillOver_20250928_160208_ori.avi",r"F:\all_flow\源哥\SpillOver_20250928_160403_ori.avi"]
    # address = [r"F:\all_flow\航哥\original_20250811145125.mp4",r"F:\all_flow\航哥\original_20250813144822.mp4"]
